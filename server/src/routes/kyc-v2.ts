...
router.get('/records', authMiddleware, (req: AuthRequest, res: Response<ApiResponse>) => {
  ...
  return res.json({ code: 0, message: 'success', data: records, timestamp: Date.now() });
});
